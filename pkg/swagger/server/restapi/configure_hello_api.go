...
func configureAPI(api *operations.HelloAPIAPI) http.Handler {
	...
	if api.PingAPIHandler == nil {
		api.PingAPIHandler = operations.PingAPIHandlerFunc(func(params operations.PingAPIParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.PingAPI has not yet been implemented")
		})
	}
