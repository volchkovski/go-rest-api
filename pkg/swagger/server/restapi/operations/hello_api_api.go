...
func NewHelloAPIAPI(spec *loads.Document) *HelloAPIAPI {
	return &HelloAPIAPI{
		...
		PingAPIHandler: PingAPIHandlerFunc(func(params PingAPIParams) middleware.Responder {
			return middleware.NotImplemented("operation PingAPI has not yet been implemented")
		}),
	}
}
...
type HelloAPIAPI struct {
	...
	// PingAPIHandler sets the operation handler for the ping API operation
	PingAPIHandler PingAPIHandler
...
func (o *HelloAPIAPI) Validate() error {
	...
	if o.PingAPIHandler == nil {
		unregistered = append(unregistered, "PingAPIHandler")
	}
...
func (o *HelloAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/ping"] = NewPingAPI(o.context, o.PingAPIHandler)
}
